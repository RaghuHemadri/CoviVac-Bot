...
class Session:
    ...
    def __init__(self, date: str, available_capacity: int, available_capacity_dose1: int, available_capacity_dose2: int, min_age_limit: int, 
    	vaccine: str, slots: List[str], **kwargs):
    
        self.date = date
        self.capacity = available_capacity
        self.dose1 = available_capacity_dose1
        self.dose2 = available_capacity_dose2
